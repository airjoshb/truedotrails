...
class ChallengesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create challenge" do
    assert_difference('Challenge.count') do
      post challenges_url, params: { challenge: { title: @challenge.title, value: @challenge.clam_value } }
    end
  ...
  test "should update challenge" do
    patch challenge_url(@challenge), params: { challenge: { title: @challenge.title, value: @challenge.clam_value } }
